...
print(dame)
#get dame's team info from player info since it isn't available in the regualar player endpoint in the api. alternatively I can pull everything straight from this dict. 
dame_id = dame[0]['id']
...
print(player_info)
#found a fanatasy nba library I can use to build the poked score. There is a total season function or you can do a lastngames if I want to have it fluctuate based on their last games. 
...
print(dame_fantasy_info['Overall'])
